...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, Username, Password, RoleId, EmployeeId, existingUser, hashedPassword, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log({ body: req.body });
                _a = req.body, Username = _a.Username, Password = _a.Password, RoleId = _a.RoleId, EmployeeId = _a.EmployeeId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 5, , 6]);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({ userId: user.UserID }, JWT_SECRET, { expiresIn: '1h' });
