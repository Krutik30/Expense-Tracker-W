        ...
        <AppBar position="static">
            <Toolbar>
                ...
                >
                    ...
                    <MenuItem component={Link} to="/add/employee">Add Employee</MenuItem>
                    <MenuItem component={Link} to="/salary/issue">Salary Issue</MenuItem>
                    <MenuItem component={Link} to="/issued/advance">Issued Advance</MenuItem>
                    <MenuItem component={Link} to="/list/employee">List of Employees</MenuItem>
                </Menu>
                {/* Render buttons on larger screens */}
                <Button color="inherit" component={Link} to="/dashboard" sx={{ display: { xs: 'none', md: 'block' } }}>
                    Dashboard
                </Button>
                <Button color="inherit" component={Link} to="/add/employee" sx={{ display: { xs: 'none', md: 'block' } }}>
                    Add Employee
                </Button>
                <Button color="inherit" component={Link} to="/salary/issue" sx={{ display: { xs: 'none', md: 'block' } }}>
                    Salary Issue
                </Button>
                <Button color="inherit" component={Link} to="/issued/advance" sx={{ display: { xs: 'none', md: 'block' } }}>
                    Issued Advance
                </Button>
                <Button color="inherit" component={Link} to="/list/employee" sx={{ display: { xs: 'none', md: 'block' } }}>
                    List of Employees
                </Button>
            </Toolbar>
        </AppBar>
